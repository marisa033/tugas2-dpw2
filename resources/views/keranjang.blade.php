              ...
              <tbody>
                <tr>
                  <th scope="row" class="border-0">
                    <div class="p-2">
                      <img src="images/women-clothes-img.png" alt="" width="70" class="img-fluid rounded shadow-sm">
                ...
                <tr>
                  <th scope="row">
                    <div class="p-2">
                      <img src="images/laptop-img.png" alt="" width="70" class="img-fluid rounded shadow-sm">
                      <div class="ml-3 d-inline-block align-middle">
                ...
                <tr>
                  <th scope="row">
                    <div class="p-2">
                      <img src="images/jhumka-img.png" alt="" width="70" class="img-fluid rounded shadow-sm">
                      <div class="ml-3 d-inline-block align-middle">
                    ...
                    <td class="border-0 align-middle text-center"><strong> <button class="btn btn-light"><i class="fa fa-minus"></i></button> 3 <button class="btn btn-light"><i class="fa fa-plus"></i></button></bu</strong></td>
                    <td class="border-0 align-middle text-center"><a href="#" class="text-dark"><i class="fa fa-trash"></i></a></td>
                    </td>
                    <tr>
                        <td></td>
